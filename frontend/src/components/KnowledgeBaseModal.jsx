                  ...
                  <div className="space-y-2">
                    {searchResults.map((result, index) => (
                      <div key={index} className="p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                        ...
                        {result.question && (
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{result.question}</p>
                        )}
                    ...
                    <div key={type}>
                      ...
                      <div className="space-y-2">
                        {items.map((item) => (
                          <div
                            key={item.id}
                            className="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-sm transition-shadow"
                          >
