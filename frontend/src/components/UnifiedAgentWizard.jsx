...
const UnifiedAgentWizard = ({ isOpen, onClose, onSubmit, agent = null }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl w-full max-w-7xl max-h-[95vh] overflow-hidden flex flex-col shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-white dark:from-purple-900/30 dark:to-gray-800">
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <div className="w-52 flex-shrink-0 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-2 overflow-y-auto hidden sm:block">
            <AgentWizardSidebar
          ...
          <div className="flex-1 overflow-y-auto p-3 sm:p-4">
            ...
            {activeSection === 'basic' && (
              <div className="space-y-4 max-w-4xl">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative">
                    {avatarError ? (
                      ...
                      <img
                        ...
                        alt="Avatar"
                        key={avatarUrl}
                        className="w-14 h-14 rounded-full transition-opacity duration-300 ease-in-out border-2 border-gray-200 dark:border-gray-600"
                  ...
                  <div>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Avatar do Agente</p>
                    <button
                      type="button"
                      onClick={refreshAvatar}
                      className="flex items-center gap-1.5 px-2.5 py-1 text-xs bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 ${
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                ...
                <div>
                  ...
                  />
                  {errors.agent_type && (
                    <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.agent_type}</p>
                  )}
                </div>
              </div>
            )}
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 ${
                          errors.products_services ? 'border-red-300 bg-red-50 dark:bg-red-900/30' : 'border-gray-300 dark:border-gray-600'
                        }`}
                        placeholder="Descreva seus produtos e serviços..."
                      />
                      {errors.products_services && (
                        <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.products_services}</p>
                      )}
                    </div>
                    ...
                    <div>
                              ...
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-1 min-w-0">
                                  <h4 className={`text-xs font-medium truncate ${
                                    isSelected ? 'text-purple-900 dark:text-purple-200' : 'text-gray-900 dark:text-gray-100'
                                  }`}>
                                    {label}
                                  </h4>
                      ...
                      {errors.objective && (
                        <p className="mt-1 text-xs text-red-600 dark:text-red-400">{errors.objective}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      {profiles ? (
                              ...
                              >
                                <div className="flex items-start gap-2">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[10px] text-gray-600 dark:text-gray-400 line-clamp-2">{profile.description}</p>
                                  </div>
                                  {isSelected && (
                        ...
                        <div className="flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-700 rounded-lg">
                          ...
                          <span className="text-gray-500 dark:text-gray-400">Carregando perfis...</span>
                        </div>
                      )}
                      {errors.behavioral_profile && (
                        <p className="mt-2 text-sm text-red-600 dark:text-red-400">{errors.behavioral_profile}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none font-mono text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                        placeholder="Olá {{primeiro_nome}}, tudo bem?&#10;&#10;Vi que você trabalha na {{empresa}} como {{cargo}}..."
                      />
                      <div className="mt-2 p-3 bg-purple-50 dark:bg-purple-900/30 rounded-lg border border-purple-100 dark:border-purple-800">
                        <p className="text-xs font-medium text-purple-800 dark:text-purple-300 mb-2">Variáveis disponíveis:</p>
                        <div className="flex flex-wrap gap-2">
                          {['{{primeiro_nome}}', '{{nome}}', '{{empresa}}', '{{cargo}}', '{{setor}}', '{{localizacao}}'].map((v) => (
                            <span key={v} className="px-2 py-1 text-xs bg-white dark:bg-gray-800 border border-purple-200 dark:border-purple-700 rounded font-mono text-purple-700 dark:text-purple-300">
                              {v}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          ...
                          return (
                            ...
                            >
                              <p className={`font-medium ${isSelected ? 'text-purple-900 dark:text-purple-200' : 'text-gray-900 dark:text-gray-100'}`}>
                                {label}
                              </p>
            ...
            {activeSection === 'business' && formData.agent_type === 'google_maps' && (
              <div className="space-y-6 max-w-3xl">
                ...
                {errors.business && (
                  <p className="text-sm text-red-600 dark:text-red-400">{errors.business}</p>
                )}
              </div>
            )}
              ...
              <div className="space-y-6 max-w-3xl">
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Apenas com telefone</span>
                  </label>
                  ...
                  <label className="flex items-center gap-3">
                    <input
                      ...
                      className="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500"
                    />
                    <span className="text-sm text-gray-700 dark:text-gray-300">Apenas com email</span>
                  </label>
                </div>
              </div>
            )}
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          ...
          {error && (
            <div className="flex-1 mx-3">
              <div className="p-1.5 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 rounded-lg text-red-700 dark:text-red-300 text-xs text-center">
                {error}
              </div>
            </div>
          )}
