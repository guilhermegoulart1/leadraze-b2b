// frontend/src/components/aiemployees/FollowUpBuilder/edges/DeletableEdge.jsx
// Custom edge with delete button on hover (reused from WorkflowBuilder)
    ...
    <>
      ...
      <BaseEdge
        ...
        style={{
          ...
          stroke: isHovered ? '#ef4444' : selected ? '#f59e0b' : style.stroke || '#f59e0b',
