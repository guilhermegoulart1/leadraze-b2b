      ...
      {types.map(type => {
        ...
        return (
          <div key={type.id} className="relative group">
            ...
            <div className="absolute left-0 bottom-full mb-1 w-56 p-2.5 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
              ...
              {showFeatures && (
                <div className="flex flex-wrap gap-1">
                  {type.features.map((feature, idx) => (
                    <span
                      key={idx}
                      className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-gray-100 text-gray-600 text-[10px] rounded-full"
                    >
