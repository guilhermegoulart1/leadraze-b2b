##### COMANDOS #####
# git add .
# git commit -m "Release v8.2.3"
# git push origin main
# git tag -a "Release v8.2.3" -F release-notes.md
# git push origin --tags
# git push origin "Release v8.2.3"
# gh release create Release v8.2.3 --title "Versão Release v8.2.3" --notes-file release-notes.md  
