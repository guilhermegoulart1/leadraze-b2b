...
console.log('🔄 Adapting multiple pages for dark mode...\n');
console.log('='.repeat(50));

pages.forEach(adaptPage);

console.log('\n' + '='.repeat(50));
console.log('✅ All pages adapted successfully!');
